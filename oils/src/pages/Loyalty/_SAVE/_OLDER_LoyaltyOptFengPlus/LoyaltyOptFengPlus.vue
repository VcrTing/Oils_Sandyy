<template>
    <v-container fluid class="qiong-txt-td">
        ...
        <qiong-header>增加LP積分</qiong-header>

        <qiong-panel-element>
            <div class="px-7 py-3">
                <!--qiong-space :space="'0.5vw'"></!--qiong-space>
                <h3 class="qiong-txt-20">添加LP積分</h3 -->
                <qiong-space :space="'0.5vw'"></qiong-space>

                <lofp-form class="my-2" ref="formREF"></lofp-form>

            </div>
            <div class="fx-c mt-3">
                <button class="btn_primry submit mx-3 px-5 py-1 fw-b round" 
                    @click="submit">
            ...
            <qiong-space class="mb-3" :space="'0.5vw'"></qiong-space>
        </qiong-panel-element>


        <div class="pti-go-top hand" @click="$router.push('option_logo')">
...
import LoLogoChangeBar from '../LoyaltyOpLogo/common/LoLogoChangeBar.vue'
import LofpForm from './Inner/LofpForm.vue'

    export default {
  components: { QiongHeaderFilter, QiongPanelElement, LofpForm, QiongSpace,
        TablePagerFooter,
    LoLogoChangeBar,
    QiongHeader
    },
