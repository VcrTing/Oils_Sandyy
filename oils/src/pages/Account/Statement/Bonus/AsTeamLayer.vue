            ...
            <div slot="body">
                ...
                <div v-if="ordering.length > 0">
                    ...
                    >
                        ...
                        <div class="qiong-wide-33">{{ v.display_name }}</div>
                        <div class="qiong-wide-10">{{ v.payment_level }}</div>
                        ...
                        <div class="qiong-wide-10">$&nbsp;{{ view.price_view(v.bonus_pv) }}</div>
                    </div>
                </div>
...
import StatementPager from '../Layout/StatementPager.vue'
    ...
    export default {
        ...
        computed: {
            has() { if (this._item && this._item.organisation_bonus_detail) { return true } },
            result() {
                let res = [ 
                        { txt: this.$t('BONUS.NORMAL.usd_team_layer'), content: `US$ 0`  },
        ...
        methods: {
            switchOrders() {
               this.loading = true
               this.ordering = this.has ? this._item.organisation_bonus_detail : [ ]
    ...
    /*
                ...
                this.total = 0
                this.ordering = this.me.bonu_period.organisation_detail
                this.ordering.map(e => {
