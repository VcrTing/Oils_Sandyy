<template>
    <pdf-content-layout :is_null="items.length > 0">
        ...
        <span slot="header">
            Enroller referral bonus for first purchase
        </span>
...
import PdfContentLayout from '../common/PdfContentLayout.vue'
    export default {
        ...
        methods: {
            fetchItems() {
                if (this._item && this._item.referal_detail) {
                    
                    this.items = this._item.referal_detail.referal_detail
                    this.usd_res = this._item.referal_detail.total_bonus
                    this.pv_res = this._item.referal_detail.total_pv
                }
            },
    ...
    /*
                ...
                this.items = this.mine.bonu_period.referral_bonus
